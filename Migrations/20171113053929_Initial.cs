        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId = table.Column<string>(type: "varchar(127)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "varchar(127)", nullable: false),
                    ApplicationId = table.Column<string>(type: "varchar(127)", nullable: true),
                    ConcurrencyToken = table.Column<string>(type: "longtext", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "varchar(127)", nullable: false),
                    ApplicationId = table.Column<string>(type: "varchar(127)", nullable: true),
                    AuthorizationId = table.Column<string>(type: "varchar(127)", nullable: true),
                    Ciphertext = table.Column<string>(type: "longtext", nullable: true),
                    ConcurrencyToken = table.Column<string>(type: "longtext", nullable: true),
                    ...
                    Hash = table.Column<string>(type: "varchar(127)", nullable: true),
